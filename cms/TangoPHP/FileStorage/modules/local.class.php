...
class TFileStoragelocal{
	...
	public function __construct(){
		$this->config=Tango::config()->get('Tangophp.filestorage', array('type'=>'local', 
			'dir_temp'=>DOCUMENT_ROOT.'/tmp', 
			'local_patch'=>DOCUMENT_ROOT.'/cms/FileStorage', 
			'nesting_depth'=>2));
	}
	...
	//	Если $copy=FALSE то файл будет в хранилище ПЕРЕМЕЩЕН
	//	Если $copy=TRUE то файл будет в хранилище СКОПИРОВАН
